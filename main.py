import pygame,  mouse, keyboard, mouse, time
from random import randint
from vars import foodnumber, foodImage, foods, screen, hungry, WIDTH, HEIGHT, duckEatImage, duckEatMuteImage, screenHEIGHT, running, duckSize, duckPos, muted, duckSpeed, duckRightMuteImage, duckLeftImage, duckLeftMuteImage, duckRightImage, quacks, numSounds, backgroundColor
